...
import { Close as CloseIcon, KeyboardBackspace as BackIcon } from "@mui/icons-material";
...
const AdaptiveDialog = ({
  ...
  // Desktop dialog
  return (
    <Dialog open={isOpen} onClose={handleClose} fullWidth={fullWidth} maxWidth={maxWidth} TransitionComponent={Transition}>
      {!hideTitleBar && (
